      ...
      <TouchableWithoutFeedback onPress={cancelFocus}>
        <SafeAreaView style={styles.childContainer}>
          <Layout style={styles.header}>
            <TouchableOpacity style={styles.viewIconBack} onPress={goBack}>
              <IconBack color={'#8F9BB3'} style={styles.iconBack} />
            </TouchableOpacity>
              ...
              {({
                ...
                <>
                  ...
                  <InputBox
                    ...
                    IconLeft={IconLock2({
                      color:
                        focusBox === 'password' ? Color.violet : Color.grayIcon,
                      style: styles.iconInput,
                    })}
                    IconRight={swichIcon({
                      icon2: EyeIcon,
                  ...
                  />
                  <Layout
                    style={[styles.viewButtonText, styles.center, styles.mV10]}>
